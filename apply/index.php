...
$grouplists = $DB->query("SELECT * FROM `homepage_groups` WHERE `group_pwd` = 0");
...
<head>
    ...
    <style>
        ...
        .homepage-center .has-feedback.feedback-left .form-control-feedback {
            left: 0;
            right: auto;
            width: 38px;
            height: 38px;
        ...
        .homepage-center .has-feedback.feedback-left.row .form-control-feedback {
            left: 15px
        }
...
<body>
    ...
    if (!empty($background = background())) {
        ...
        echo '<div class="row homepage-wrapper" style="background-image:  url(' . $background . ');background-size: cover;">';
    } else {
        echo '<div class="row homepage-wrapper">';
    }
    ?>
    <div class="homepage-form">
        <div class="homepage-center">
            <?php if ($conf["apply"] == 2): ?>
                <div class="homepage-header text-center">
                    <h2>网站已关闭收录</h2>
                </div>
                <div class="apply_gg">
