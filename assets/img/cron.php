...
例如：
$pass = 'homepage';
CRON地址为：http://hao.homepage.com/assets/img/cron.php?key=homepage
...
function get_curl($url)
{
	...
	curl_setopt_array($curl, array(
		...
		CURLOPT_HTTPHEADER => array(
			'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.54 Safari/537.36 Edg/101.0.1210.39 Chrome/101.0.1210.39'
		),
	));
