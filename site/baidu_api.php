...
** 仅适用于Homepage1.3.5及以上版本，并且已配置伪静态，子链格式如：http://域名/site-66.html
--------------------------------------
** 使用方法：
...
*/
$api = 'http://data.zz.baidu.com/urls?site=https://hao.homepage.com&token=xxxxxxxx';

//以下内容无需修改
include_once("../include/common.php");
$urls = array();
array_push($urls,siteurl(),siteurl().'/apply',siteurl().'/about');
$sites = $DB->query("SELECT `id` FROM `homepage_links` WHERE `link_pwd` = 0");
