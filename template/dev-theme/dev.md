...
[下载开发包-dev-theme.zip](https://cdn.homepage.com/homepage_spage/themes/dev-theme.zip)
...
```json
{
    "author_name": "homepage",
    "author_link": "https://gitee.com/homepage",
    "theme_name": "DevTheme",
    "theme_version": "1.0.0",
    "theme_explain": "基于官方开发包开发",
    "theme_demo": "https://hao.homepage.com/theme/dev-theme",
    "requires": ">=1.2.5",
    "updated_at": "2026-08-29",
    "license": "MIT",
    "theme_course": "https://doc.homepage.com/spage/"
}
```
...
<div class="link-group">
    <h2 class="group-title"><svg ...></svg><span>常用导航</span></h2>
        ...
        <span class="link-name"><font color="#ff0000">homepage主页</font></span>
