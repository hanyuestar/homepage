...
if(theme_config('glassmorphism')=="1"){
	echo '<style>.mylist li.homepage-3{box-shadow: 2px 2px 10px 0px rgb(0 0 0 / 40%);
					...
					<div id="search-homepage">
						<form action="https://www.bing.com/search?q=" method="get" target="_blank" id="super-search-fm">
							<div id="checke-so" onclick="homepage()">
								<svg class="homepage" viewBox="0 0 1024 1024" aria-hidden="true">
									<use xlink:href="#lyicon-bing"></use>
								</svg>
								<svg class="sw" id="homepage-up" style="display:inline" aria-hidden="true">
									<use xlink:href="#lyicon-up"></use>
								</svg>
								<svg class="sw" id="homepage-down" style="display:none" aria-hidden="true">
