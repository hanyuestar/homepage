...
<body>
	...
	<div class="box">
		<div class="change-type">
			<div class="type-left" id="type-left">
				<ul>
					<li data-homepage="search"><a>搜索</a><span></span></li>
					<?php
					$groups = $site->getGroups(); // 获取分类
					while ($group = $DB->fetch($groups)) { //循环所有分组

						echo '<li data-homepage="group_' . $group["group_id"] . '"><a>' . $group["group_name"] . '</a><span></span></li>' . "\n";
					}
					?>
				</ul>
			</div>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="position: absolute; z-index: 10000;">
		<!--<a class="navbar-brand" href="/"><img src="./assets/img/logo.png" height="25"  title="Homepage_Spage"></a>-->
