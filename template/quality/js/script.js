...
function homepage(){
    var up = document.getElementById('homepage-up');
    var down = document.getElementById('homepage-down');
    var homepage = document.getElementById('chso');
    ...
    if(upsw=='none'){
        ...
        homepage.style.display='contents';
    }
...
function() {
	...
	function v(a) {
        ...
        document.getElementById('homepage-up').style.display='inline';
        document.getElementById('homepage-down').style.display='none';
