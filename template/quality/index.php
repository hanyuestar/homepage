...
<html lang="zh-CN" element::-webkit-scrollbar {display:none}>
	<head>
		...
		<meta name="author" content="Homepage_pro">
...
<?php
		...
		<!--搜索开始-->
			<div id="search" class="s-search">
				...
				id="super-search-fm">
				    <div id="checke-so" onclick="homepage()">
				    <svg class="homepage" aria-hidden="true"><use xlink:href="#lyicon-bing"></use></svg>
				    <svg class="sw" id="homepage-up" style="display:inline" aria-hidden="true"><use xlink:href="#lyicon-up"></use></svg>
				    <svg class="sw" id="homepage-down" style="display:none" aria-hidden="true"><use xlink:href="#lyicon-down"></use></svg>
				    </div>
