 ...
 * @FilePath: /homepage/include/lists.php
 * @Copyright (c) 2024 by Homepage, All Rights Reserved. 
 */
// +----------------------------------------------------------+
// | Homepage                                              |
// +----------------------------------------------------------+
// | Copyright (c) 2022 Homepage                                 |
// +----------------------------------------------------------+
// | File: lists.php                                          |
// +----------------------------------------------------------+
// | Authors: Homepage <admin@homepage.com>                         |
// | date: 2022-06-10                                         |
// +----------------------------------------------------------+
...
function lists($htmls)
{
    ...
    $groups = $DB->query("SELECT * FROM `homepage_groups` ORDER BY `group_order` ASC");
    if ($groups === false) {
    ...
    while ($group = $DB->fetch($groups)) {
        ...
        $sql = "SELECT * FROM `homepage_links` WHERE `group_id` = " . $groupId . " ORDER BY `link_order` ASC;";
