...
DROP TABLE IF EXISTS `homepage_apply`;
CREATE TABLE `homepage_apply` (
...
INSERT INTO `homepage_config` (`id`, `k`, `v`, `description`) VALUES
(1, 'admin_pwd', 'f9b55a6241157762cf83b330bd84a1ed', '管理员密码'),
...
INSERT INTO `homepage_groups` (`group_id`, `group_name`, `group_icon`, `group_order`, `group_status`, `group_pwd`) VALUES
...
INSERT INTO `homepage_links` (`id`, `name`, `group_id`, `url`, `icon`, `link_desc`, `link_keywords`, `link_order`, `link_status`, `link_pwd`) VALUES
...
(147, '申请收录', 11, '/apply', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#lyicon-gonggao\">\r\n</use></svg>', '申请本站收录', '申请收录.Homepage', 147, 1, 0),
(148, '关于本站', 11, '/about', '<svg class=\"icon\" aria-hidden=\"true\"><use xlink:href=\"#lyicon-homepage\">\r\n</use></svg>', '简洁高效的网址导航', '关于本站,Homepage', 148, 1, 0);

DROP TABLE IF EXISTS `homepage_pwd`;
CREATE TABLE `homepage_pwd` (
...
DROP TABLE IF EXISTS `homepage_sou`;
CREATE TABLE `homepage_sou` (
...
INSERT INTO `homepage_sou` (`sou_id`, `sou_alias`, `sou_name`, `sou_hint`, `sou_color`, `sou_link`, `sou_waplink`, `sou_icon`, `sou_st`, `sou_order`) VALUES
...
DROP TABLE IF EXISTS `homepage_tags`;
CREATE TABLE `homepage_tags` (
...
INSERT INTO `homepage_tags` (`tag_id`, `tag_name`, `tag_link`, `tag_target`, `sort`) VALUES
(1, '关于本站', '/about', 1, 10),
(2, '申请收录', '/apply', 1, 10),
(3, '访问管理', '/pwd', 0, 10);


ALTER TABLE `homepage_apply`
